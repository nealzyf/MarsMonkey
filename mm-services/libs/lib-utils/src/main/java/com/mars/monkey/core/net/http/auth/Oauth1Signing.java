...
public final class Oauth1Signing {
    ...
    private Oauth1Signing(String consumerKey, String consumerSecret, String accessToken,
    ...
    public String signRequest(String url,String method,String bodyString) throws IOException {
        ...
        for (int i = 0; i < httpUrl.querySize(); i++) {
            parameters.put(ESCAPER.escape(httpUrl.queryParameterName(i)),
                    ESCAPER.escape(httpUrl.queryParameterValue(i)));
        }

        Buffer body = new Buffer();
        body = body.writeUtf8(bodyString);
        ...
        base.writeByte('&');
        base.writeUtf8(ESCAPER.escape(httpUrl.newBuilder().query(null).build().toString()));
        base.writeByte('&');
    ...
    public static final class Builder {
        ...
        public Oauth1Signing build() {
            ...
            return new Oauth1Signing(consumerKey, consumerSecret, accessToken, accessSecret, random,
                    clock);
        }
    }
}